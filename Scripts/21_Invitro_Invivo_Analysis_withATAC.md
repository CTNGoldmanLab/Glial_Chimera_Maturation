...
```
    ...
    ## Ncells   9343790  499.1   30397940 1623.5         NA  17792939  950.3
    ## Vcells 503422077 3840.9  832107279 6348.5     102400 617407898 4710.5
...
![](21_Invitro_Invivo_Analysis_withATAC_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
transitionExpr <- AverageExpression(transition, assays = "SCENIC", group.by = "stage")$SCENIC

min_non_zero <- min(transitionExpr[transitionExpr != 0])
pseudocount <- 0.5 * min_non_zero

transitionExprLog2 <- as.data.frame(log2(transitionExpr + pseudocount))

transitionExprLog2$Log2FC <- transitionExprLog2$`In Vivo` - transitionExprLog2$`In Vitro - GPC Stage`
transitionExprLog2 <- transitionExprLog2[match(transitionSCENIC.sig$regulon, row.names(transitionExprLog2)),]
transitionSCENIC.sig$avg_log2FC <- transitionExprLog2$Log2FC
...
![](21_Invitro_Invivo_Analysis_withATAC_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](21_Invitro_Invivo_Analysis_withATAC_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](21_Invitro_Invivo_Analysis_withATAC_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](21_Invitro_Invivo_Analysis_withATAC_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](21_Invitro_Invivo_Analysis_withATAC_files/figure-gfm/unnamed-chunk-15-2.png)<!-- -->
...
![](21_Invitro_Invivo_Analysis_withATAC_files/figure-gfm/unnamed-chunk-15-3.png)<!-- -->
...
![](21_Invitro_Invivo_Analysis_withATAC_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](21_Invitro_Invivo_Analysis_withATAC_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
```
    ...
    ## 3   ATF4 3.780858e-05   0.3847923  9.551858e-38  0.3126232    red2
    ## 12  EGR2 1.504435e-07   0.3165878  0.000000e+00  4.0835402    red2
    ## 15  FOSB 2.955135e-08   0.7091832  0.000000e+00  3.9014828    red2
    ## 29  PBX1 3.836731e-06  -0.4747069  7.063754e-06 -0.3938835 #2E30FF
    ## 30 PRRX1 4.483357e-09   0.4571844 7.112844e-291  1.8598003    red2
    ## 42 TEAD2 8.934306e-09  -2.6906521  6.016986e-10 -0.2378423 #2E30FF
...
```
    ...
    ##     Gene     Gene_FDR Gene_Log2FC       AUC_FDR AUC_Log2FC   color
    ## 8   DLX1 9.511443e-04  -0.4141617 2.146662e-148  -2.872586 #2E30FF
    ## 9   DLX2 1.572389e-03  -0.5144474 2.806264e-300  -1.418123 #2E30FF
    ## 10  DLX5 3.108525e-09  -2.6906521  0.000000e+00  -2.145021 #2E30FF
    ## 16 FOXG1 3.821273e-03  -0.4726944 1.290627e-245  -1.475960 #2E30FF
    ## 28 OLIG2 5.927470e-05   0.6453371 2.194532e-280   1.076924    red2
    ## 33 SOX10 1.553081e-04   0.6429352 1.160765e-304   1.578016    red2
    ## 38  SOX8 4.181229e-05   0.5621610 3.713533e-237   1.222183    red2
...
```
    ...
    ## [29] RColorBrewer_1.1-3          ggplot2_3.5.2              
    ## [31] devtools_2.4.5              usethis_2.1.6              
    ## [33] SeuratObject_5.0.2          Seurat_4.3.0               
    ## [35] dplyr_1.1.1                
    ## 
    ## loaded via a namespace (and not attached):
    ##   [1] utf8_1.2.3             spatstat.explore_3.2-7 reticulate_1.43.0     
    ...
    ##  [61] ellipsis_0.3.2         sessioninfo_1.2.2      ggridges_0.5.7        
