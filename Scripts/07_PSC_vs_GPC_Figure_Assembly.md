...
plot_long <- plot_long[plot_long$Gene %in% plot_long[abs(plot_long$Value) > .8 & plot_long$Type == "RNA",]$Gene,]
...
bottom <- ggplot(plot_long, aes(Gene, Type)) + 
  ...
  scale_fill_gradient2(low = "mediumseagreen", mid = "white", high = "#2E30FF", midpoint = 0, limits=c(-3,3), breaks=c(-2,-1,0,1,2), name="log2 fold change", na.value="black", oob = scales::squish, guide = guide_colorbar(barwidth = .5)) +
...
```
    ...
    ##  [3] scPlottingTools_0.0.0.9000  ggplot2_3.5.2              
    ...
    ##   [1] spam_2.10-0            systemfonts_1.0.4      plyr_1.8.8            
    ##   [4] igraph_2.0.3           lazyeval_0.2.2         sp_1.6-0              
    ##   [7] splines_4.2.3          listenv_0.9.0          scattermore_0.8       
    ##  [10] digest_0.6.31          htmltools_0.5.5        fansi_1.0.4           
    ##  [13] magrittr_2.0.3         tensor_1.5             cluster_2.1.4         
    ##  [16] ROCR_1.0-11            globals_0.16.2         spatstat.sparse_3.0-3 
    ##  [19] colorspace_2.1-0       ggrepel_0.9.3          textshaping_0.3.6     
    ##  [22] xfun_0.38              dplyr_1.1.1            crayon_1.5.2          
    ##  [25] RCurl_1.98-1.12        jsonlite_1.8.4         progressr_0.13.0      
    ##  [28] spatstat.data_3.0-4    survival_3.5-5         zoo_1.8-11            
    ##  [31] glue_1.6.2             polyclip_1.10-4        gtable_0.3.3          
    ##  [34] zlibbioc_1.44.0        XVector_0.38.0         leiden_0.4.3          
    ##  [37] DelayedArray_0.24.0    future.apply_1.10.0    abind_1.4-5           
    ##  [40] scales_1.3.0           DBI_1.1.3              spatstat.random_3.2-3 
    ##  [43] miniUI_0.1.1.1         Rcpp_1.0.10            viridisLite_0.4.1     
    ##  [46] xtable_1.8-4           reticulate_1.43.0      dotCall64_1.1-1       
    ##  [49] htmlwidgets_1.6.2      httr_1.4.5             RColorBrewer_1.1-3    
    ##  [52] ellipsis_0.3.2         ica_1.0-3              pkgconfig_2.0.3       
    ##  [55] farver_2.1.1           uwot_0.1.14            deldir_1.0-6          
    ...
    ##  [67] generics_0.1.3         ggridges_0.5.7         evaluate_0.20         
    ##  [70] stringr_1.5.0          fastmap_1.1.1          ragg_1.2.5            
    ##  [73] yaml_2.3.7             goftest_1.2-3          knitr_1.42            
    ...
    ##  [88] spatstat.utils_3.1-0   tibble_3.2.1           stringi_1.7.12        
    ##  [91] highr_0.10             lattice_0.21-8         Matrix_1.6-4          
    ##  [94] vctrs_0.6.1            pillar_1.9.0           lifecycle_1.0.3       
    ##  [97] spatstat.geom_3.2-9    lmtest_0.9-40          RcppAnnoy_0.0.20      
    ...
    ## [109] vipor_0.4.7            parallelly_1.35.0      codetools_0.2-19      
    ## [112] MASS_7.3-58.3          rprojroot_2.0.3        withr_2.5.0           
    ## [115] sctransform_0.3.5      GenomeInfoDbData_1.2.9 parallel_4.2.3        
    ## [118] grid_4.2.3             rmarkdown_2.21         Cairo_1.6-2           
    ## [121] Rtsne_0.16             spatstat.explore_3.2-7 shiny_1.7.4           
    ## [124] ggbeeswarm_0.7.2
