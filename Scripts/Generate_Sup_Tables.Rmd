...
```
## In Vitro Specificty Scores
```{r}

invitroSpecificity <- read.csv("output/DE/invitroSpecificity.csv")

write.xlsx(invitroSpecificity, file = "output/SupTables/SupTable2.xlsx", sheetName = "Specificity Scores", row.names = F, append = T)
...
invivo.invitro.consensus <- invivo.invitro.consensus[,c(1,2,3,6,8,10,14,15)]
...
write.xlsx(invivo.invitro.consensus, file = "output/SupTables/SupTable4.xlsx", sheetName = "In vivo vs in vitro scATAC Consensus", append = T, row.names = F) 


invivo.invitro.primed <- merge(Invivo.vs.Invitro.GPC4.sig, invitro.GPC4.atacOnly, by.x = "Gene", by.y = 1)
invivo.invitro.primed <- invivo.invitro.primed[,c(1,2,3,6,8,10)]
...
write.xlsx(invivo.invitro.primed, file = "output/SupTables/SupTable4.xlsx", sheetName = "In vivo vs in vitro scATAC Primed", append = T, row.names = F) 
