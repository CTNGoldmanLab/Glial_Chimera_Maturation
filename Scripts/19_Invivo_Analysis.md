Analysis of Human Cells out of Shiverer Chimeras
================
John Mariani
12/6/2022
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->

``` r
## Calculate better LogFCs since the previous calculation is meant for gene expression count data
differentiationExpr <- AverageExpression(invivo, assays = "SCENIC", group.by = "cellType")$SCENIC
min_non_zero <- min(differentiationExpr[differentiationExpr != 0])
pseudocount <- 0.5 * min_non_zero

differentiationExprLog2 <- as.data.frame(log2(differentiationExpr + pseudocount))
...
differentiationExprLog2$imOL.vs.GPC <- differentiationExprLog2$imOL - differentiationExprLog2$GPC
imOL.vs.GPC.SCENIC.sig$avg_log2FC <- as.numeric(mapvalues(imOL.vs.GPC.SCENIC.sig$TF, from = row.names(differentiationExprLog2), to = differentiationExprLog2$imOL.vs.GPC))
```

    ## The following `from` values were not present in `x`: ARNT, ARX, ATF6, ATF6B, ATOH8, CARF, CEBPB, CREB3, CTBP1, CXXC1, DEAF1, DLX6, ESR2, ETV6, FOXD3, FOXN2, FOXN3, GTF2A1, HESX1, HIF1A, IRF3, KLF11, KLF9, LHX2, MAFB, MAFK, MECP2, MEF2D, MLXIP, MYBL2, MZF1, NANOG, NCOR1, NFE2L3, NHLH2, NR1H3, NR2C1, OTX1, PHF8, PLAGL2, POLE3, POLR2A, POU2F1, POU5F1, PTPMT1, PURA, PURG, RARA, RBBP5, RXRB, SIX4, SNAI1, SNAI3, SOX3, SP1, SP8, SPAG7, SREBF1, TFAP4, THAP11, TP53, TRIM21, TRIM28, ZBTB17, ZBTB18, ZBTB43, ZBTB49, ZBTB7A, ZBTB7B, ZFP14, ZFP64, ZFY, ZKSCAN4, ZNF189, ZNF19, ZNF256, ZNF274, ZNF319, ZNF34, ZNF362, ZNF510, ZNF546, ZNF560, ZNF561, ZNF586, ZNF768, ZNF786, ZSCAN32
...
differentiationExprLog2$maOL.vs.imOL <- differentiationExprLog2$maOL - differentiationExprLog2$imOL
maOL.vs.imOL.SCENIC.sig$avg_log2FC <- as.numeric(mapvalues(maOL.vs.imOL.SCENIC.sig$TF, from = row.names(differentiationExprLog2), to = differentiationExprLog2$maOL.vs.imOL))
```

    ## The following `from` values were not present in `x`: ARID3A, ARNTL2, ARX, ATF6, BCL3, BCL6, BDP1, BRCA1, CEBPD, CREB3, CREB3L1, CREB3L4, CREBL2, CTBP1, CUX2, CXXC1, DBP, DLX6, DUS3L, E2F8, EBF1, EMX2, ENO1, ESR2, ETS2, FOSB, FOSL1, FOXG1, FOXN3, FOXO3, FOXP2, GLI1, GLIS3, GMEB2, GTF2A1, HES7, HESX1, IRF3, IRF6, IRF9, KDM5A, KLF15, KLF3, KLF6, KLF7, MAFB, MAFK, MEF2D, MEIS2, MSX1, MYB, MYCN, NCOR1, NFE2L3, NFYC, NHLH2, NKX1.2, NR1H2, NR2E1, NR2F2, OTX1, PBX1, PLAGL1, PLAGL2, POU2F1, POU3F4, POU5F1, POU6F1, PPARD, RARA, RFXANK, RORA, RREB1, SETBP1, SIN3A, SIX4, SMARCC1, SNAI1, SNAI3, SOX3, SP2, SP5, SPAG7, SPIB, SPR, TBL1XR1, TEAD2, THAP1, TP53, TRIM21, UQCRB, YY2, ZBTB43, ZBTB49, ZFP14, ZFP64, ZIC1, ZIC4, ZIC5, ZKSCAN4, ZNF141, ZNF217, ZNF236, ZNF256, ZNF319, ZNF34, ZNF394, ZNF467, ZNF502, ZNF510, ZNF546, ZNF560, ZNF561, ZNF595, ZNF628, ZNF721, ZNF75A, ZNF76, ZNF782, ZNF786
...
differentiationExprLog2$imAstro.vs.GPC <- differentiationExprLog2$imAstrocyte - differentiationExprLog2$GPC
imAstro.vs.GPC.SCENIC.sig$avg_log2FC <- as.numeric(mapvalues(imAstro.vs.GPC.SCENIC.sig$TF, from = row.names(differentiationExprLog2), to = differentiationExprLog2$imAstro.vs.GPC))
```

    ## The following `from` values were not present in `x`: AEBP2, ARID3A, ARNT, ARNT2, ATF1, ATF2, ATF4, ATF5, ATF6, ATF6B, BACH2, BBX, BCL3, BCL6, BDP1, BRCA1, BRF1, BRF2, CARF, CEBPG, CREB1, CREB3L2, CREB3L4, CTBP1, CUX2, CXXC1, DEAF1, DNMT3A, DUS3L, E2F1, E2F4, E2F6, EGR1, ELF2, ENO1, ESR2, ETS2, ETV3, FOS, FOSL1, FOXD3, FOXJ2, FOXK1, FOXN2, FOXO4, FOXP2, GABPB1, GLIS3, GMEB1, GMEB2, GTF2A1, GTF2B, GTF2F1, GTF3C2, HCFC1, HDAC2, HESX1, HSF1, HSF2, IRF9, KLF11, LHX2, MAFB, MAFK, MECP2, MEF2A, MEF2D, MEIS2, MITF, MLX, MSX1, MYCN, NCOR1, NFATC1, NFE2L1, NFE2L3, NFIL3, NFYA, NHLH2, NKX6.2, NR1H2, NR1H3, NR2C1, NR2C2, NR2F2, NRF1, OTX1, PATZ1, PHF8, PLAGL2, POLE4, POU2F1, POU5F1, POU6F1, PPARA, PRDM10, RARA, RBBP5, RELB, RFX5, RORA, RXRA, RXRB, RXRG, SMARCC1, SNAI3, SP1, SP2, SPAG7, SSBP3, TBL1XR1, TCF3, TCF7, TEF, THAP1, TRIM21, TRIM28, UQCRB, USF1, XBP1, YBX1, YY2, ZBTB43, ZBTB7A, ZFP14, ZFP62, ZFP64, ZKSCAN4, ZNF141, ZNF189, ZNF19, ZNF217, ZNF250, ZNF256, ZNF362, ZNF384, ZNF394, ZNF510, ZNF530, ZNF546, ZNF560, ZNF561, ZNF586, ZNF595, ZNF628, ZNF704, ZNF721, ZNF75A, ZNF76, ZNF786, ZNF816, ZSCAN32, ZXDB
...
differentiationExprLog2$Astro.vs.imAstro <- differentiationExprLog2$Astrocyte - differentiationExprLog2$imAstrocyte
Astro.vs.imAstro.SCENIC.sig$avg_log2FC <- as.numeric(mapvalues(Astro.vs.imAstro.SCENIC.sig$TF, from = row.names(differentiationExprLog2), to = differentiationExprLog2$Astro.vs.imAstro))
```

    ## The following `from` values were not present in `x`: AEBP2, ALX1, ARID3A, ARNT, ARNT2, ARNTL2, ARX, ATF5, ATF6, ATOH8, BACH1, BACH2, BARX1, BBX, BCL3, BDP1, BRF1, CARF, CEBPD, CEBPG, CLOCK, CNOT3, CREB1, CREB3, CREB3L1, CREB3L4, CREB5, CREBL2, CREM, CTBP1, CTCF, CUX1, CUX2, CXXC1, DBP, DLX6, DNMT3A, DUS3L, E2F2, E2F3, E2F4, E2F5, E2F6, E2F7, EBF1, EGR1, EGR2, ELF1, ELK1, ELK4, EMX1, ERF, ESR2, ESRRA, ETS2, ETV3, ETV6, FOS, FOSB, FOSL1, FOXG1, FOXJ2, FOXK1, FOXN2, FOXN3, FOXO3, FOXO6, FOXP2, GABPA, GLI1, GMEB1, GMEB2, GRHL1, GTF2A1, GTF2B, GTF2F1, GTF3C2, HES7, HESX1, HMGA1, HSF2, IRF3, IRF6, IRX3, JDP2, JUNB, JUND, KLF10, KLF11, KLF16, KLF7, LHX4, MAF, MAFB, MAFF, MAFG, MAFK, MAZ, MECP2, MEF2A, MEF2D, MEIS2, MEIS3, MITF, MLX, MLXIP, MXD4, MYB, MYBL2, MYC, MYCN, MYEF2, NCOR1, NFATC1, NFE2L3, NFIA, NFYA, NFYB, NFYC, NHLH2, NKX2.2, NKX2.3, NR1H2, NR1H3, NR2C1, NR2C2, NR2F6, NR3C1, NRF1, ONECUT2, OTX1, PBX1, PDLIM5, PLAGL2, PML, POLR2A, POLR3A, POLR3G, POU2F1, POU5F1, POU6F1, PPARA, PPARD, PRDM16, PURA, PURG, RAD21, RARA, RARG, RBBP5, RELB, RFX5, RFX7, RFXANK, RLF, RORA, RXRA, RXRG, SIN3A, SIX4, SMAD1, SMAD3, SMARCC1, SMARCC2, SNAI3, SOX10, SOX2, SOX4, SOX6, SOX8, SP1, SP8, SPAG7, SREBF2, SSBP3, STAT2, STAT5B, STAT6, TBL1XR1, TBPL1, TCF12, TCF3, TCF7, TEAD2, TEAD3, TEAD4, TP53, TRIM21, TRIM28, USF1, XBP1, YY2, ZBTB17, ZBTB18, ZBTB43, ZBTB49, ZBTB7A, ZFHX2, ZFP62, ZFP64, ZFX, ZFY, ZIC1, ZIC3, ZIC4, ZKSCAN4, ZNF112, ZNF121, ZNF141, ZNF143, ZNF19, ZNF200, ZNF217, ZNF236, ZNF256, ZNF263, ZNF34, ZNF362, ZNF384, ZNF394, ZNF460, ZNF467, ZNF502, ZNF510, ZNF530, ZNF546, ZNF554, ZNF555, ZNF560, ZNF561, ZNF595, ZNF628, ZNF66, ZNF721, ZNF75A, ZNF76, ZNF782, ZNF786, ZNF816, ZNF844, ZSCAN32, ZXDB
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-15-2.png)<!-- -->

``` r
tfHMgg | geneHMgg
```

![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-15-3.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-16-2.png)<!-- -->

``` r
tfHMgg.astro | geneHMgg.astro
```

![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-16-3.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-17-2.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-22-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
\## Top Figure
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->
\## cGPC vs cAPC
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-31-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-33-1.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-33-2.png)<!-- -->
...
![](19_Invivo_Analysis_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
```
    ...
    ## [31] ggplot2_3.5.2               scPlottingTools_0.0.0.9000 
    ...
    ##   [9] scattermore_0.8           digest_0.6.31            
    ##  [11] htmltools_0.5.5           fansi_1.0.4              
    ##  [13] tensor_1.5                cluster_2.1.4            
    ##  [15] ROCR_1.0-11               limma_3.54.2             
    ##  [17] globals_0.16.2            spatstat.sparse_3.0-3    
    ##  [19] RVenn_1.1.0               colorspace_2.1-0         
    ##  [21] textshaping_0.3.6         xfun_0.38                
    ##  [23] crayon_1.5.2              RCurl_1.98-1.12          
    ##  [25] progressr_0.13.0          spatstat.data_3.0-4      
    ...
    ##  [37] abind_1.4-5               edgeR_3.40.2             
    ##  [39] DBI_1.1.3                 spatstat.random_3.2-3    
    ##  [41] miniUI_0.1.1.1            Rcpp_1.0.10              
    ##  [43] xtable_1.8-4              reticulate_1.43.0        
    ##  [45] dotCall64_1.1-1           htmlwidgets_1.6.2        
    ##  [47] httr_1.4.5                RColorBrewer_1.1-3       
    ##  [49] ellipsis_0.3.2            ica_1.0-3                
    ##  [51] pkgconfig_2.0.3           rJava_1.0-6              
    ##  [53] farver_2.1.1              uwot_0.1.14              
    ##  [55] deldir_1.0-6              locfit_1.5-9.7           
    ...
    ##  [67] ggridges_0.5.7            evaluate_0.20            
    ##  [69] stringr_1.5.0             fastmap_1.1.1            
    ##  [71] ragg_1.2.5                yaml_2.3.7               
    ##  [73] goftest_1.2-3             knitr_1.42               
    ##  [75] fitdistrplus_1.1-8        purrr_1.0.1              
    ##  [77] RANN_2.6.1                sparseMatrixStats_1.10.0 
    ##  [79] pbapply_1.7-0             future_1.32.0            
    ##  [81] nlme_3.1-162              mime_0.12                
    ##  [83] ggrastr_1.0.2             compiler_4.2.3           
    ##  [85] rstudioapi_0.14           beeswarm_0.4.0           
    ##  [87] plotly_4.10.1             png_0.1-8                
    ##  [89] spatstat.utils_3.1-0      tibble_3.2.1             
    ##  [91] stringi_1.7.12            highr_0.10               
    ##  [93] lattice_0.21-8            Matrix_1.6-4             
    ##  [95] vctrs_0.6.1               pillar_1.9.0             
    ##  [97] lifecycle_1.0.3           spatstat.geom_3.2-9      
    ##  [99] lmtest_0.9-40             RcppAnnoy_0.0.20         
    ## [101] cowplot_1.1.1             bitops_1.0-7             
    ## [103] irlba_2.3.5.1             httpuv_1.6.9             
    ## [105] R6_2.5.1                  promises_1.2.0.1         
    ## [107] KernSmooth_2.23-20        gridExtra_2.3            
    ## [109] vipor_0.4.7               parallelly_1.35.0        
    ## [111] codetools_0.2-19          MASS_7.3-58.3            
    ## [113] xlsxjars_0.6.1            rprojroot_2.0.3          
    ## [115] withr_2.5.0               sctransform_0.3.5        
    ## [117] GenomeInfoDbData_1.2.9    mgcv_1.8-42              
    ## [119] parallel_4.2.3            grid_4.2.3               
    ## [121] DelayedMatrixStats_1.20.0 rmarkdown_2.21           
    ## [123] Rtsne_0.16                spatstat.explore_3.2-7   
    ## [125] shiny_1.7.4               ggbeeswarm_0.7.2
