...
![](23_Mouse_Analysis_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](23_Mouse_Analysis_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](23_Mouse_Analysis_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](23_Mouse_Analysis_files/figure-gfm/unnamed-chunk-5-2.png)<!-- -->
...
![](23_Mouse_Analysis_files/figure-gfm/unnamed-chunk-5-3.png)<!-- -->
...
![](23_Mouse_Analysis_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->

``` r
(mouseDim | figMouseB) + plot_layout(widths = c(1,1.5))
```

![](23_Mouse_Analysis_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
```
    ...
    ## [27] ggplot2_3.5.2               scPlottingTools_0.0.0.9000 
    ## [29] SeuratObject_5.0.2          Seurat_4.3.0               
    ## 
    ...
    ##  [19] colorspace_2.1-0       ggrepel_0.9.3          xfun_0.38             
    ...
    ##  [49] ica_1.0-3              pkgconfig_2.0.3        rJava_1.0-6           
    ##  [52] farver_2.1.1           uwot_0.1.14            deldir_1.0-6          
    ##  [55] locfit_1.5-9.7         utf8_1.2.3             labeling_0.4.2        
    ##  [58] tidyselect_1.2.0       rlang_1.1.0            reshape2_1.4.4        
    ##  [61] later_1.3.0            munsell_0.5.0          tools_4.2.3           
    ##  [64] cli_3.6.1              generics_0.1.3         ggridges_0.5.7        
